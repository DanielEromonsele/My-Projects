...
const App = () => {
  ...
  const fetchData = () => {
    const url: string = "http://localhost:2003/api/get-todos";
  ...
  const updateProgressData = (ID: string) => {
    const url: string = `http://localhost:2003/api/progress/${ID}`;
  ...
  const updateDoneData = (ID: string) => {
    const url: string = `http://localhost:2003/api/done/${ID}`;
  ...
  const createTask = () => {
    const url: string = "http://localhost:2003/api/create/";
